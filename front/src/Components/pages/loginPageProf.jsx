...
function LoginPageProf () {
    const [email, setEmail] = useState("")
    const [password, setPassword] = useState("")

    const { signInProf, signedProf } = useContext(AuthContext)
                        ...
                        <div className={styles.login_page}>
                            <form onSubmit={handleSignIn} className={styles.login_form}>
                                ...
                                <div className={styles.text_center}>
                                    ...
                                    <Link className={styles.text_2} to={"/programas/inscricoeseresultados/inscriçoes"}>Se inscreva</Link>
                                </div>
                            </form>
                        </div>
                    </div>
